...
////////////////////////////////////////////////////////////////////////////////////////////////
void RC5::Rc5InitKey(const unsigned char bufKey[RC5_16])
{
	// 保存m_bufKey
	try {
	...
	unsigned long	x, y;
	i = j = x = y = 0;
	for (k = 0; k < 3 * max(RC5_KEY, RC5_SUB); k++)
	{
...
////////////////////////////////////////////////////////////////////////////////////////////////
void RC5::Rc5Encrypt(void* buf, int nLen8)
{
	//	ASSERT(nLen8 % 8 == 0);
	nLen8 = (nLen8 / 8) * 8;
	if (nLen8 <= 0)
...
////////////////////////////////////////////////////////////////////////////////////////////////
void RC5::Rc5Decrypt(void* buf, int nLen8) {
	//	ASSERT(nLen8 % 8 == 0);
	nLen8 = (nLen8/8) * 8;
	if(nLen8 <= 0)
	return;
